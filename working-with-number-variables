...
#You're building a recipe scaler to adjust ingredient quantities for different party sizes. 
#Your base recipe for pasta sauce serves 4 people and requires certain amounts of ingredients.
#Some ingredients come in whole units, while others need decimal measurements.
#You need to store these quantities using the appropriate data types so your recipe scaler can perform calculations accurately later.
